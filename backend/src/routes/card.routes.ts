...
import { CardParamsSchema, CardReorderSchema, CardSchema, UpdateCardSchema } from "../validators/card.validator.js";
import { createCardController, deleteCardController, getCardsController, reorderCardController, updateCardController } from "../controllers/card.controller.js";
...
router.patch("/cards/reorder", authentication, validate(CardReorderSchema, "body"), reorderCardController);
